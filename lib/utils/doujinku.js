...
// doujinkudl("https://doujinku.co/milf-hunter-from-another-world-chapter-1/")
//   .then((result) => {
//     console.log(result);
//   })
//   .catch((err) => {
...
// doujinkudetail(
//   "https://doujinku.co/manga/hadaka-skate-wa-itsumo-dareka-ni-mirarenagara-ikoma-ayuka/"
// )
//   .then((result) => {
//     console.log(result);
//   })
...
//     console.log(err.message);
//   });
// doujinkudetail("https://doujinku.co/manga/i-have-to-sleep-with-a-stranger/")
//   .then((result) => {
//     console.log(result);
//   })
//   .catch((err) => {
